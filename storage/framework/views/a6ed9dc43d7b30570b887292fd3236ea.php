            ...
            <div class="row mb-0">
                ...
                <div class="col-lg-3 col-xl-2">
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('employees.create')); ?>" class="btnbtn-primary">Create Employee</a>
                    </div>
                </div>
            </div>
            <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Materi Kuliah\Semester 4\PEMROGRAMAN FRAMEWORK\Percobaan Lanjutan\Ini-Lanjutan\resources\views/employee/index.blade.php ENDPATH**/ ?>